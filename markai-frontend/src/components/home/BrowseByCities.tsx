    ...
    return (
        <section className="relative w-full py-10 overflow-hidden transition-colors duration-300" style={{ backgroundColor: 'var(--bg-primary)' }}>
            ...
            <div className="dark:block hidden absolute inset-0">
                ...
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_right,rgba(31,196,207,0.14),transparent_55%)]" />
            </div>
                        ...
                        >
                            ...
                            <div className="relative h-[300px] md:h-[400px] lg:h-full overflow-hidden">
                                ...
                                <div className="absolute top-6 left-6">
                                    <span className="brand-gradient-bg inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                            ...
                            <div className="p-6 md:p-8">
                                <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-6">
                                    <div className="text-center p-4 rounded-xl transition-colors duration-300" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-primary)', borderWidth: '1px', borderStyle: 'solid' }}>
                                        <Building2 className="w-6 h-6 mx-auto mb-2" style={{ color: 'var(--brand-blue)' }} />
                                    ...
                                    <div className="text-center p-4 rounded-xl transition-colors duration-300" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-primary)', borderWidth: '1px', borderStyle: 'solid' }}>
                                        <MapPin className="w-6 h-6 mx-auto mb-2" style={{ color: 'var(--brand-cyan)' }} />
                                    ...
                                    <div className="col-span-2 md:col-span-1 text-center p-4 rounded-xl transition-colors duration-300" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-primary)', borderWidth: '1px', borderStyle: 'solid' }}>
                                        <Sparkles className="w-6 h-6 mx-auto mb-2" style={{ color: 'var(--brand-purple)' }} />
                                ...
                                <div className="flex items-center justify-between p-4 md:p-6 rounded-xl border transition-colors duration-300" style={{ background: 'var(--brand-gradient)', opacity: 0.97 }}>
                                    {/* brand-tinted CTA strip */}
                                    <div className="flex-1">
                                        <p className="font-semibold mb-1 text-base md:text-lg text-white">Explore screens in Bengaluru</p>
                                        <p className="text-sm md:text-base text-white/80">Start your campaign today</p>
                                    </div>
                                    <ArrowRight className="w-6 h-6 md:w-8 md:h-8 text-white group-hover:translate-x-2 transition-all duration-300 shrink-0" />
                                </div>
                            </div>
                        </motion.div>
                    </Link>
